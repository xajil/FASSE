    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">TECNO SHOP</small></h1>
            </div>
            <p class="lead text-center">
              Por favor ingrese sus datos para poder proceder a sus compras.
            </p>
            <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp; Ingrese su número de DPI-CUI</label>
                                  <input class="form-control" type="text" required name="clien-nit" pattern="[0-9]{1,15}" title="Ingrese su número de DPI-CUI. Solamente números" maxlength="13" >
                                </div>
                              </div>
