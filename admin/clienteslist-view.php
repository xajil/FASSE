...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="configAdmin.php?view=clienteslist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Clientes de la tienda</a>
    </li>
</ul>
<div class="container">
	<div class="row">
		<div class="col-xs-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading text-center"><h4>Cliente de la tienda</h4></div>
                  ...
                  <table class="table table-striped table-hover">
                      	...
                      	<tbody>
                          	<?php
								...
								$proveedores=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM cliente ");
                ...
                <?php if($numeropaginas>=1): ?>
                  ...
                  <ul class="pagination">
                    ...
                    <?php else: ?>
                        <li>
                            <a href="configAdmin.php?view=clienteslist&pag=<?php echo $pagina-1; ?>">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php
                        for($i=1; $i <= $numeropaginas; $i++ ){
                            if($pagina == $i){
                                echo '<li class="active"><a href="configAdmin.php?view=clienteslist&pag='.$i.'">'.$i.'</a></li>';
                            }else{
                                echo '<li><a href="configAdmin.php?view=clienteslist&pag='.$i.'">'.$i.'</a></li>';
                            }
                        }
                    ?>
