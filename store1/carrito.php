    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>CARRITO DE COMPRAS <small class="tittles-pages-logo">TECNO SHOP</small></h1>
            </div>
            <br><br><br>
            <div class="row">
                <div class="col-xs-12">
                    <?php
                        ...
                        if(!empty($_SESSION['carro'])){
                            ...
                            echo '<tr class="bg-danger"><td colspan="2">Total</td><td><strong>'.$sumaA.'</strong></td><td><strong>Q'.number_format($suma,2).'</strong></td></tr></table><div class="ResForm"></div>';
                            echo '
                            <p class="text-center">
