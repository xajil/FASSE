...
<body id="container-page-index">
    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 1;">
...
<div class="carousel-inner" role="listbox">
    <div class="item active">
        <img src="./assets/img/d.png" alt="slider1">
        <div class="carousel-caption">
        
        </div>
    </div>
    <div class="item">
        <img src="./assets/img/ofertas.png" alt="slider2">
        <div class="carousel-caption">
            
        </div>
    </div>
    <div class="item">
        <img src="./assets/img/a.jpg" alt="slider3">
        <div class="carousel-caption">
            
        </div>
    </div>
    <div class="item">
        <img src="./assets/img/b.jpg" alt="slider4">
        <div class="carousel-caption">
            
        </div>
    </div>
    <div class="item">
        <img src="./assets/img/c.jpg" alt="slider5">
        <div class="carousel-caption">
