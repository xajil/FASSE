       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">TECNO SHOP</small></h1>
            </div>
            <?php
            ...
            <?php
                ...
                $producto=consultasSQL::clean_string($_GET['prod']);
            ...
            <?php
                  ...
                  $consulta= ejecutarSQL::consultar("SELECT * FROM producto WHERE Stock > 0 AND Estado='Activo'");
                ...
                <div class="text-center">
                  <ul class="pagination">
                    ...
                    <?php else: ?>
                        <li>
                            <a href="product.php?prod=<?php echo $producto; ?>&pag=<?php echo $pagina-1; ?>">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php
                        for($i=1; $i <= $numeropaginas; $i++ ){
                            if($pagina == $i){
                                echo '<li class="active"><a href="product.php?prod='.$producto.'&pag='.$i.'">'.$i.'</a></li>';
                            }else{
                                echo '<li><a href="product.php?prod='.$producto.'&pag='.$i.'">'.$i.'</a></li>';
                            }
                        }
                    ?>
