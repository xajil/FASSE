    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                ...
                <?php
                    $code=$_GET['code'];
                    $cliente=ejecutarSQL::consultar("SELECT * FROM cliente WHERE NITProveedor='$code'");
                    $prov=mysqli_fetch_array($cliente, MYSQLI_ASSOC);
                ?>
                <form action="process/updateClient.php" method="POST" class="FormCatElec" data-form="update">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" type="text" value="<?php echo $prov['NombreCompleto']; ?>" name="prove-name" maxlength="30" required="">
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group label-floating">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" value="<?php echo $prov['Email']; ?>" type="url" name="prove-web">
                                </div>
                            </div>
                        </div>
                    </div>
