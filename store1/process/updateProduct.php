...
$descripProdUP=consultasSQL::clean_string($_POST['prod-descrip-price']);
...
if($imgName!=""){
  if($imgType=="image/jpeg" || $imgType=="image/png"){
    if(($imgSize/1024)<=$imgMaxSize){
        ...
        $imgFinalName2=$codeOldProdUp."2".$imgEx;
...
if($imgName!=""){
  if($imgType=="image/jpeg" || $imgType=="image/png"){
    if(($imgSize/1024)<=$imgMaxSize){
        ...
        $imgFinalName3=$codeOldProdUp."3".$imgEx;
...
if(consultasSQL::UpdateSQL("producto", "NombreProd='$nameProdUp',CodigoCat='$catProdUp',Precio='$priceProdUp',Descuento='$descProdUp',Modelo='$modelProdUp',Marca='$marcaProdUp',Stock='$stockProdUp',NITProveedor='$proveProdUp',Estado='$EstadoProdUp',descripcion='$descripProdUP'", "CodigoProd='$codeOldProdUp'")){
   echo '<script>
    swal({
