    ...
    <section id="prove-product-cat-config">
        <div class="container">
          <div class="page-header">
            <h1>Panel de administración <small class="tittles-pages-logo">TECNO SHOP</small></h1>
          </div>
          <!--====  Nav Tabs  ====-->
          ...
          <?php
            $content=$_GET['view'];
            $WhiteList=["product","productlist","productinfo","report","reporttwo","provider","providerlist","providerinfo","clientlist","category","categorylist","categoryinfo","admin","adminlist","order","bank","account"];
            if(isset($content)){
