              ...
              <strong>Tipo de cuenta:</strong> <?php echo $datBank['TipoCuenta']; ?><br><br>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="tipo-envio" data-toggle="tooltip" data-placement="top" title="Elige El Tipo De Envio">
                      ...
                      <option value="Envio Por Cargo Express">Envio Gratis</option> 
                  </select>
               </div>
                <div class="form-group">
                    <label>DPI/CUI del cliente</label>
                    <input class="form-control" type="text" name="Cedclien" placeholder="DPI/CUI del cliente" maxlength="15" required="">
                </div>
                <div class="form-group">
