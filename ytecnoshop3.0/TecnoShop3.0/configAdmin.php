...
<body id="container-page-configAdmin">
    ...
    <section id="prove-product-cat-config">
        <div class="container">
          ...
          <?php
            $content=$_GET['view'];
            $WhiteList=["product","productlist","productinfo","report","provider","providerlist","providerinfo","client","clientlist","category","categorylist","categoryinfo","admin","adminlist","order","bank","account"];
            if(isset($content)){
