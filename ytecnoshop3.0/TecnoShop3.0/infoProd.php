...
<body id="container-page-product">
    ...
    <section id="infoproduct">
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h1>DETALLE DE PRODUCTO <small class="tittles-pages-logo">TECNO SHOP</small></h1>
                </div>
                <?php 
                    $CodigoProducto=consultasSQL::clean_string($_GET['CodigoProd']);
                    $productoinfo=  ejecutarSQL::consultar("SELECT producto.CodigoProd,producto.NombreProd,producto.CodigoCat,categoria.Nombre,producto.Precio,producto.Descuento,producto.Stock,producto.Imagen,producto.descripcion,producto.Imagen2,producto.Imagen3 FROM categoria INNER JOIN producto ON producto.CodigoCat=categoria.CodigoCat  WHERE CodigoProd='".$CodigoProducto."'");
                    while($fila=mysqli_fetch_array($productoinfo, MYSQLI_ASSOC)){
                        echo '
                            ...
                            if($fila['Imagen2']!="" && is_file("./assets/img-products/".$fila['Imagen2'])){ 
                                $imagenFile2="./assets/img-products/".$fila['Imagen2']; 
                            }else{ 
                                $imagenFile2="./assets/img-products/default.png"; 
                            }
                           

                        if($fila['Imagen3']!="" && is_file("./assets/img-products/".$fila['Imagen3'])){ 
                            $imagenFile3="./assets/img-products/".$fila['Imagen3']; 
                        }else{ 
                            $imagenFile3="./assets/img-products/default.png"; 
                        }
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
                <img class="img-responsive" src="'.$imagenFile2.'">
                <div class="carousel-caption">
                </div>
            </div>
            <div class="item">
                <img class="img-responsive" src="'.$imagenFile3.'">
                <div class="carousel-caption">
                </div>
            </div>
        </div>
