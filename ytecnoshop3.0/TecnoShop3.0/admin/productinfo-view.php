                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-12">
                              <div class="form-group label-floating">
                                ...
                                <input type="text" class="form-control" value="<?php echo $prod['descripcion']; ?>" name="prod-descrip-price">
                              </div>
                            </div>
                            <div class="col-xs-12">
                            ...
                            <div class="col-xs-12">
                                <legend>Imagen/Foto del producto 2</legend>
                                <p class="text-center text-primary">
                                    No es necesario actualizar la Imagen/Foto del producto, sin embargo si desea actualizarla seleccione una en el siguiente campo. Formato de imágenes admitido png y jpg. Tamaño máximo 5MB
                                </p>
                            </div>
                            ...
                            <div class="col-xs-12">
                                <legend>Imagen/Foto del producto 3</legend>
                                <p class="text-center text-primary">
                                    No es necesario actualizar la Imagen/Foto del producto, sin embargo si desea actualizarla seleccione una en el siguiente campo. Formato de imágenes admitido png y jpg. Tamaño máximo 5MB
                                </p>
                            </div>
